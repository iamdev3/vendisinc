...
<table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0">
  <tr>
    <td style="padding-right: 0px;padding-left: 0px;" align="center">
      ...
      <img align="center" border="0" src="https://assets.unlayer.com/projects/0/1764351095053-Gemini_Generated_Image_707js6707js6707j-removebg-preview.png" alt="" title="" style="outline: none;text-decoration: none;-ms-interpolation-mode: bicubic;clear: both;display: inline-block !important;border: none;height: auto;float: none;width: 50%;max-width: 238px;" width="238"/>
    ...
    <div class="email-wrapper">
        <div class="email-container">
            <div class="email-body">
                <p class="email-text">
                    નમસ્તે <strong>{{ $customer_name }}</strong>,
                </p>
                
                <p class="email-text">
                    {{ $company_name }} માં જોડાવા બદલ આભાર! અમે તમને અમારી સાથે જોઈને ખુશ છીએ.
                </p>
                
                <p class="email-text">
                    તમારું એકાઉન્ટ સફળતાપૂર્વક બનાવવામાં આવ્યું છે: <strong>{{ $user_email }}</strong>
                </p>
                
                <center>
                    <a href="{{ $dashboard_url }}" class="welcome-button">ડેશબોર્ડ પર જાઓ</a>
                </center>
                
                <p class="email-text">
                    જો તમને કોઈ પ્રશ્ન હોય, તો અમારી સપોર્ટ ટીમનો સંપર્ક કરવામાં અચકાશો નહીં.
                </p>
                
                <p class="email-text">
                    શુભેચ્છા સહ,<br>
                    <strong>{{ $company_name }} ટીમ</strong>
                </p>
            </div>
            
            <div class="email-footer">
                <p style="margin: 0;">
                    © 2024 {{ $company_name }}. તમામ હક્કો સુરક્ષિત.
                </p>
            </div>
        </div>
    </div>
