...
<table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0">
  <tr>
    <td style="padding-right: 0px;padding-left: 0px;" align="center">
      ...
      <img align="center" border="0" src="https://assets.unlayer.com/projects/0/1764350816633-Gemini_Generated_Image_707js6707js6707j-removebg-preview.png" alt="" title="" style="outline: none;text-decoration: none;-ms-interpolation-mode: bicubic;clear: both;display: inline-block !important;border: none;height: auto;float: none;width: 50%;max-width: 238px;" width="238"/>
    ...
    <div class="email-wrapper">
        <div class="email-container">            
            ...
            <div class="email-body">
                ...
                <p class="email-text">
                    Thank you for joining {{ $company_name }}! We're excited to have you with us.
                </p>
                
                <p class="email-text">
                    Your account has been created successfully with email: <strong>{{ $user_email }}</strong>
                </p>
                
                <center>
                    <a href="{{ $dashboard_url }}" class="welcome-button">Go to Dashboard</a>
                </center>
