...
{   
    ...
    protected ?string $description = 'Key metrics and statistics for your business';
    ...
    {   
        ...
        $statsDetails = [
            ...
            [
                ...
                'value'             => $totalBrand,
                'value_type'        => 'number',
                'shortDescription'  => "Active brand partnerships",
                'description'       => "Total number of brands registered in the system. Only active brands are counted in business metrics.",
            ...
            [
                ...
                'value'             => $totalProduct,
                'value_type'        => 'number',
                'shortDescription'  => "Products in catalog",
                'description'       => "Total number of products across all brands. This includes both active and inactive products.",
            ...
            [
                ...
                'description'       => "Number of product categories used to organize products. Categories help in better product management.",
                'icon'              => "heroicon-m-tag",
                'color'             => "warning",
            ...
            [
                ...
                'value'             => $totalOrder,
                'value_type'        => 'number',
                'shortDescription'  => "All order records",
                'description'       => "Total number of orders placed, including pending, confirmed, shipped, delivered, cancelled, and on-hold orders.",
            ...
            [
                ...
                'value_type'        => 'number',
                'shortDescription'  => "Confirmed & shipped orders",
                'description'       => "Number of orders that are confirmed or shipped but not yet delivered. These orders are currently in transit or being processed for delivery.",
            ...
            [
                ...
                'value_type'        => 'amount',
                'shortDescription'  => "Value of pending orders",
                'description'       => "Total monetary value of orders with 'pending' as payment status. These orders are awaiting to be paid.",
            ...
            [
                ...
                'value'             => $totalProfit,
                'value_type'        => 'amount',
                'shortDescription'  => "Profit from delivered orders",
                'description'       => "Total profit generated from delivered orders & payment status mark as paid. Profit is calculated as sell price minus base cost for each product.",
